...
angular.module('transcript.app.transcript', ['ui.router'])
    ...
    .config(['$stateProvider', function($stateProvider) {
        $stateProvider.state('app.transcript', {
            ...
            resolve: {
                ...
                transcriptRights: function(TranscriptService) {
                    return TranscriptService.getTranscriptRights();
                }
            }
        })
    }])
    ...
    .controller('AppTranscriptCtrl', ['$rootScope','$scope', '$http', '$sce', '$state', 'transcript', 'resource', 'transcriptRights', 'ContentService', function($rootScope, $scope, $http, $sce, $state, transcript, resource, transcriptRights, ContentService) {
        // fullscreen doc : https://developer.mozilla.org/fr/docs/Web/CSS/:fullscreen
        ...
        $scope.role = transcriptRights; console.log(transcriptRights);
